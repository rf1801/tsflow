...
model = load_model("C:/Users/raouf/Desktop/pfe/history/keras_soft/mobilenet_epochs_3_batch_64_lr_0.001_attention_True.keras")  # Replace 'path_to_your_model.h5' with the actual path
